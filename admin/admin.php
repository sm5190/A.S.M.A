...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Heading -->
            <div class="sidebar-heading" "margin-top: 3%">
                Interface
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto" >
                        ...
                        <h1 class="h3 mb-0 text-gray-800" align="center" >Welcome To Admin Page</h1>
            ...
            <?php    $sql2="DECLARE var2 NUMBER; var1 NUMBER; BEGIN profit_calcs(var2,var1); END;";
		$statement2=oci_parse($conn,$sql2);
        oci_execute($statement2);
        $sql3="SELECT profit_value from profit ";
