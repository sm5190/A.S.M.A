...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#experience">View Bookings</a>
...
$sql="SELECT * from employee_profile where contact_number='$user_check'";
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">Welcome 
          <span class="text-primary"><?php echo $row['E_NAME'];?></span>
        </h1>
        <div class="subheading mb-5">Provided Phone Number:
          <a href="#"><?php echo $row['CONTACT_NUMBER'];?></a>
        </div>
      ...
      <div class="w-100">
        ...
        <ul class="fa-ul mb-0">
          <li>
            ...
            Permanent Address: <?php echo $row['PERMANENT_ADDRESS']; ?></li>
          <li>
            <i class="fa-li fa fa-trophy text-warning"></i>
            Current Address : <?php echo $row['CURRENT_ADDRESS']; ?></li>
          <li>
            <i class="fa-li fa fa-trophy text-warning"></i>
           
            Bonus if any : <?php echo $row['BONUS']; ?></li>
...
<tr>
    ...
    <th>service Issued</th>
    <th>Customer Issued</th>

  </tr>
<?php
$sql3="SELECT e_id from employee where contact_number='$user_check'";
$statement3=oci_parse($conn,$sql3);
oci_execute($statement3);
$row3=oci_fetch_array($statement3);
$cid = $row3['E_ID'] ;

$sql1="SELECT  ap_time,ap_date , customer_name, service_name from appointment_view_employee  where  e_id='$cid'";
