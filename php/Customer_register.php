<?php
    ...
    if(isset($_POST)) {
        ...
        $sql="INSERT INTO customer (customer_id,customer_name, phone_number,address, allergy, skin_type, hair_type, c_pass)values (' ','$name', '$phn','$add' ,'$allergies', '$s_type', '$h_type', '$pass')";
